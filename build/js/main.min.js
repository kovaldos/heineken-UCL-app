...
/* harmony import */ var _modules_form_additional_form_validate__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/form/additional-form-validate */ "./js/modules/form/additional-form-validate.js");
/* harmony import */ var _modules_init_selected_player__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/init-selected-player */ "./js/modules/init-selected-player.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_form_init_form_validate__WEBPACK_IMPORTED_MODULE_3__["initFormValidate"])(); // iniAdditionalFormValid();
    // initSelectedPlayer();
  });
}); // ---------------------------------
...
/***/ "./js/modules/form/additional-form-validate.js":
/*!*****************************************************!*\
  !*** ./js/modules/form/additional-form-validate.js ***!
  \*****************************************************/
/*! exports provided: iniAdditionalFormValid */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "iniAdditionalFormValid", function() { return iniAdditionalFormValid; });
// Дополнительная валидация возраста пользователя на стартовом экране -- Начало --
var iniAdditionalFormValid = function iniAdditionalFormValid() {
  var ageForm = document.querySelector('.age-control-form');

  function serializeForm(formNode) {
    var data = new FormData(formNode);
    var yearOfBirth = Array.from(data.entries());
...
var baseValidationSuccessCallback = function baseValidationSuccessCallback(e) {
  ...
  var data = formData.get('month') + '/' + formData.get('day') + '/' + formData.get('year');
  var birthDate = new Date(data);
  var today = new Date();
  var validAge = 568036800000; // 18 years in milliseconds
...
/***/ "./js/modules/init-selected-player.js":
/*!********************************************!*\
  !*** ./js/modules/init-selected-player.js ***!
  \********************************************/
/*! exports provided: initSelectedPlayer */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initSelectedPlayer", function() { return initSelectedPlayer; });
var initSelectedPlayer = function initSelectedPlayer() {
  var avatars = document.querySelectorAll('.screen04__pic');
